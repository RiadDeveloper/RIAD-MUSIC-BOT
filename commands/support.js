...
module.exports = {
  ...
  run: async (client, interaction) => {
    try {
      ...
      const supportServerLink = "https://discord.gg/6zvNYrjzP6";
      const youtubeLink = "https://www.youtube.com/@MusicalRiad";
        const embed = new EmbedBuilder()
            ...
            .setImage('https://i.postimg.cc/T1Gj45zZ/standard-1.gif')
            .setTimestamp();
